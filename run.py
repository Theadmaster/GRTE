...
parser.add_argument('--dataset', default='CA', type=str)
...
parser.add_argument('--bert_vocab_path', default="./pretrained/bert-base-chinese/vocab.txt", type=str)
parser.add_argument('--bert_config_path', default="./pretrained/bert-base-chinese/config.json", type=str)
parser.add_argument('--bert_model_path', default="./pretrained/bert-base-chinese/pytorch_model.bin", type=str)
